# Embedded file name: Charlie's Shed.py
                            ...
                            if 0 < xpos < 20 * len(players[turnnumber].handcards):
                                if Is_Playable(players[turnnumber].handcards[int(xpos / 20)]):
                                    ...
                                    if playedcards[-1][0:2] == '10':
                                        playedcards = []
                                        if len(players[turnnumber].handcards) != 0 and len(players[turnnumber].hiddencards) != 0:
                                            firstplayedcard = False
...
def Get_Player_Parameters():
    ...
    for x in range(0, humanplayers):
        playerorder.append(raw_input('Who goes in position ' + str(x) + "? Type 'AI' for AI player\n> "))
